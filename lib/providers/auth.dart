...
class AuthCntrl with ChangeNotifier {
  Timer _authTimer;
  ...
  Future<void> signup(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAnx3lJ5EyLos0plnc4vDVIAT8BwHW0Rp4");
  ...
  Future<void> login(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAnx3lJ5EyLos0plnc4vDVIAT8BwHW0Rp4");
